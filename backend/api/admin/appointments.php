<?php
// This endpoint manages appointments for the admin panel.
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
	$sql = "SELECT a.id, a.patient_id, a.doctor_id, a.appointment_date, a.time_slot, a.visit_reason, a.notes, a.status, a.created_at, 
	               p.full_name AS patient_name, p.phone AS patient_phone, p.email AS patient_email, p.nic AS patient_nic,
