...
class Appointment {
	...
	// Returns appointments that were BOOKED (created) today, regardless of which
	// date the appointment itself is scheduled for. Used to notify receptionists
	// of new incoming bookings as soon as they open the dashboard.
